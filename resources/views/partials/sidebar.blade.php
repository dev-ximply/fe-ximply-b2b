...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs  border-0 border-radius-xl  fixed-start" id=""
    ...
    {{-- <aside class="sidenav navbar navbar-vertical navbar-expand-xs  border-0 border-radius-xl  fixed-start " id=""
    style="border-radius: 0 !important ; background-image: url('{{ asset('img/curved-images/sidebar.png') }}');background-size:cover"> --}}
    ...
    <div class="collapse navbar-collapse w-auto h-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#expenseDown" class="nav-link @if ($section == 'expense' || $section == 'approval') active @endif" >
                    <div
                    ...
                    <span
                        class="nav-link-text ms-1  {{ $section == 'expense' || $section == 'approval' ? 'text-orange' : 'text-white' }}">Manage Expenses</span>
                </a>
            ...
            <li class="nav-item">
                ...
                role="button" aria-expanded="false">
                    ...
                    <span
                        class="nav-link-text ms-1 {{ $section == 'employee' || $section == 'group' || $section == 'partner' ? 'text-orange' : 'text-white' }}">Manage Teams</span>
                </a>
                    ...
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            ...
                            <a class="nav-link @if ($section == 'partner') active @endif " href="/partner">
                                <span class="sidenav-mini-icon text-white"> O </span>
                                <span class="nav-link-text ms-1  text-white">Partner</span>
                            </a>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#ecommerceExamples"
                    class="nav-link  @if ($section == 'budget' || $section == 'top_up_approval' || $section == 'pre-approval') active @endif" aria-controls="ecommerceExamples"
                    role="button" aria-expanded="false">
                    <div
                    ...
                    <span
                        class="nav-link-text ms-1 {{ $section == 'budget' || $section == 'top_up_approval' || $section == 'pre-approval' ? 'text-orange' : 'text-white' }}">Manage Budget</span>
                </a>
                <div class="collapse @if ($section == 'budget' || $section == 'top_up_approval' || $section == 'pre-approval') show @endif" id="ecommerceExamples">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            ...
                            <a class="nav-link @if ($section == 'top_up_approval') active @endif " href="/spend/request">
                                <span class="sidenav-mini-icon text-white"> O </span>
                                <span class="nav-link-text ms-1  text-white">Top Up Approval</span>
                            </a>
                            <a class="nav-link @if ($section == 'pre-approval') active @endif " href="/pre-approval">
                                <span class="sidenav-mini-icon text-white"> O </span>
                                <span class="nav-link-text ms-1  text-white">Pre Approval</span>
                            </a>
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#settings"
                    class="nav-link  @if ($section == 'settings' || $section == 'permission' || $section == 'tenant') active @endif" aria-controls="ecommerceExamples"
                    role="button" aria-expanded="false">
                    <div
                ...
                <div class="collapse @if ($section == 'settings' || $section == 'permission' || $section == 'tenant') show @endif" id="settings">
                    <ul class="nav ms-4 ps-3">
                        <li class="nav-item ">
                            {{-- <a class="nav-link @if ($section == 'settings') active @endif" href="/settings">
                                <span class="sidenav-mini-icon text-white"> O </span>
                                <span class="nav-link-text ms-1 text-white">Role</span>
                            </a> --}}
                            ...
                            <a class="nav-link @if ($section == 'tenant') active @endif " href="/tenant">
                                <span class="sidenav-mini-icon text-white"> O </span>
                                <span class="nav-link-text ms-1  text-white">Tenant</span>
                            </a>
            ...
            {{-- <li class="nav-item">
                <a class="nav-link @if ($section == 'settings') active @endif" href="/settings">
                    <div
                        class="icon  icon-sm shadow border-radius-md  text-center  me-2 d-flex align-items-center justify-content-center {{ $section == 'settings' ? 'bg-orange' : 'bg-purple' }}">
                        <i class="fa-solid fa-screwdriver-wrench {{ $section == 'settings' ? 'text-white' : 'text-white' }}"
                            style="font-size:15px"></i>
                    </div>
                    <span
                        class="nav-link-text ms-1 {{ $section == 'settings' ? 'text-orange' : 'text-purple' }}">Settings</span>
                </a>
            </li> --}}
        </ul>
    </div>
