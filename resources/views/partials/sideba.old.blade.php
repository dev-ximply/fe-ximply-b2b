            ...
            @if (session()->get('policies') == 1)
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#settings"
                        class="nav-link  @if ($section == 'settings' || $section == 'permission' || $section == 'tenant' || $section == 'account_settings') active @endif"
                        aria-controls="ecommerceExamples" role="button" aria-expanded="false">
                        <div
                            class="icon  icon-sm shadow border-radius-md  text-center  me-2 d-flex align-items-center justify-content-center {{ $section == 'settings' || $section == 'permission' || $section == 'tenant' || $section == 'account_settings' ? 'bg-orange' : 'bg-purple' }}">
                        ...
                        <span
                            class="nav-link-text ms-1 {{ $section == 'settings' || $section == 'permission' || $section == 'tenant' || $section == 'account_settings' ? 'text-orange' : 'text-white' }}">Settings</span>
                    </a>
                    <div class="collapse @if ($section == 'settings' || $section == 'permission' || $section == 'tenant' || $section == 'account_settings') show @endif" id="settings">
                        <ul class="nav ms-4 ps-3">
                            <li class="nav-item ">
