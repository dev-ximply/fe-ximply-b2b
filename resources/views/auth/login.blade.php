...
<head>
    ...
    <style>
        ...
        .input-group-text:focus{
            border-color: 2px solid #191a4d !important;
        }
    </style>
</head>
                ...
                <div class="container">
                    <div class="row">
                                    ...
                                    <form role="form" class="pt-0" method="POST"
                                        ...
                                        <div class="row row-cols-2 login_App">
                                            <div class="col-md mt-3 d-md-none d-block">
                                                <a  class="btns d-flex align-items-center" target="_blank"
                                                    href="https://play.google.com/store/apps/details?id=com.ximply.flutter_beazy"
                                                    style="width:130px;height:40px">
                                                    <div class="d-flex flex-row pt-1" style="width:100px;height:40px">
                                            ...
                                            <div class="col-md mt-3 d-md-none d-block">
                                                <a class="btns d-flex align-items-center"
                                                    style="width:130px;height:40px">
                                                    <div class="d-flex flex-row pt-1" style="width:130px;height:40px">
                                                        ...
                                                        <img src="{{ asset('img/icons/btn-app-store.png') }}" alt="" style="min-width: 100%">
                                                    </div>
                                                </a>
                                            </div>
                                        </div>
                        ...
                        <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column"
                            ...
                            {{-- <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 end-0 text-center justify-content-center flex-column"
                            style="border-top-left-radius:30px; border-bottom-left-radius:30px;background:#19194b;background-size:cover; -webkit-box-shadow: -5px 3px 12px 4px rgba(173,173,173,0.16);
                            -moz-box-shadow: -5px 3px 12px 4px rgba(173,173,173,0.16);
                            box-shadow: -5px 3px 12px 4px rgba(173,173,173,0.16);"> --}}
                            <div
